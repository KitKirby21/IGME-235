...
function createLabelsAndButtons() {
    ...
    startButton.on('pointerover', e => e.target.alpha = 0.7); // concise arrows function with no brackets
    ...
    playAgainButton.on("pointerup",startGame); // startGame is a fucntion reference
...
function gameLoop(){
    ...
    // lerp (linear interpolate) the x & y value lerp()
...
function loadSpriteSheet() {
    ...
    // http://[ixijs.download/release/docs/PIXI.BaseTexture.html
